        ...
        <div class="panel-body">
            <form role="form" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-110">
                              <div class='input-group'>
                                  <input class="form-control" name="rango" placeholder="Por ejemplo: Morelos" value="<?php echo $rango; ?>">
								  <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                              </div> 
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-110">
                              <div class='input-group'>
                                  <input type="text" class="form-control"  name="frecuencia_cal" placeholder="Por ejemplo: 0.3 - 5" value="<?php echo $frecuencia_calibracion; ?>">
								  <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                              </div> 
                          </div>
                        </div>
