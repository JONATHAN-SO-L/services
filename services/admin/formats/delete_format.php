...
if( $_SESSION['nombre']!="" && $_SESSION['clave']!="" && $_SESSION['tipo']=="admin"){
  ...
  function mensaje_error() {
    echo'
                <div class="alert alert-danger alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    ...
                    <p class="text-center">
                        No fue posible eliminar el formato, por favor inténtalo de nuevo o contacta al Soporte Técnico.
                    </p>
                </div>
            '; 
  }
  ...
  function mensaje_ayuda(){
        echo '
            ...
            <p class="text-center">
            Se eliminió correctamente el formato.
            </p>
            </div>
            ';
    }
	...
	function redirect_failed($format) {
		echo '
			<div class="container" style="margin-left: 40%">
				...
				<br>
				<a href="delete_format.php?'.$format.'" class="btn btn-sm btn-danger" style="margin-left: 15%">Regresar</a>
			</div>';
	}
    ...
    if (isset($_POST['eliminar_formato'])) {
        // Recepción de datos
        $formatos = 'formatos';
        ...
        $delete_format = $con->prepare("DELETE FROM $formatos WHERE formato = ?");

        $val_delete_format = $delete_format->execute([$format]);

        if ($val_delete_format) {
            // Registro en auditlog
            $log = 'auditlog';
            $movimiento = utf8_decode('El usuario '.$tecnico.' elimina el formato '.$nombre_formato.' con revision '.$revision_formato.' el '.$fecha_hora_eliminacion.'');
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header2">
                <h1 class="animated lightSpeedIn">Eliminar Formato: <strong><?php echo $format; ?></strong></h1>
  ...
  <div class="row">
    <div class="col-sm-8">
      <div class="panel panel-danger">
        <div class="panel-heading text-center"><strong>Por favor valida la información que será eliminada permanentemente.</strong></div>
        <div class="panel-body">
            <form role="form" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class='col-sm-110'>
                                <div class="input-group">
                                   <input class="form-control" type="text" name="nombre_formato" placeholder="Por ejemplo: FDV-S-032" value="<?php echo $nombre_formato; ?>" readonly>
						...
						<div class="form-group">
                            <label class="col-sm-222 control-label"><i class="fa fa-barcode" aria-hidden="true"></i> REV:</label>
                             <div class="col-sm-110">
                              <div class='input-group'>
                                <input type="text" class="form-control" name="revision_formato" placeholder="Por ejemplo: 0; 05/20" value="<?php echo $revision_formato; ?>" readonly>
                                <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                              </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          <div class="col-sm-offset-2 col-sm-10 text-center"><br>
                              <button type="submit" name="eliminar_formato" class="btn btn-danger">Eliminar</button>
                          </div>
                        </div>
                    <br>
            </form>
