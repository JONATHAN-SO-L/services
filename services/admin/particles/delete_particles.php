...
if( $_SESSION['nombre']!="" && $_SESSION['clave']!="" && $_SESSION['tipo']=="admin"){
  ...
  function mensaje_error() {
    echo'
                <div class="alert alert-danger alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    ...
                    <p class="text-center">
                        No fue posible eliminar la información de la partícula, por favor inténtalo de nuevo o contacta al Soporte Técnico.
                    </p>
                </div>
            '; 
  }
  ...
  function mensaje_ayuda(){
        echo '
            ...
            <h4 class="text-center"><strong>ELIMACIÓN EXITOSA</strong></h4>
            <p class="text-center">
            Se eliminó correctamente la infromación de la partícula.
            </p>
            </div>
            ';
    }
    ...
    if (isset($_POST['eliminar_particula'])) {
        // Recpción de datos
        ...
        $delete_particle= $con->prepare("DELETE FROM $particles WHERE id_particula = ?");
        $val_delete_particle = $delete_particle->execute([$particle]);

        if ($val_delete_particle) {
            // Registro en auditlog
            $movimiento = utf8_decode('El usuario '.$tecnico.' modificó la partícula '.$tamano_nominal.' con número de lote '.$no_lote.', estado '.$estado.' y fecha de expiración '.$exp_fecha.' el '.$fecha_hora_modificacion.'');
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header2">
                <h1 class="animated lightSpeedIn">Eliminar Partícula: <strong><?php echo $particle; ?></strong></h1>
  ...
  <div class="row">
    <div class="col-sm-8">
      <div class="panel panel-danger">
        <div class="panel-heading text-center"><strong>Para poder eliminar una partícula es necesario llenar los siguientes campos.</strong></div>
        <div class="panel-body">
            <form role="form" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class='col-sm-110'>
                                <div class="input-group">
                                   <input class="form-control" type="text" name="tamano_real" placeholder="Por ejemplo: 0.003" value="<?php echo $tamano_real; ?>" readonly>
								   <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                                </div>
                            </div>
                        </div>
						<div class="form-group">
                          ...
                          <div class="col-sm-110">
                              <div class='input-group'>
                                  <input type="text" class="form-control" name="desviacion_tamano" placeholder="Por ejemplo: 0.0066" value="<?php echo $desviacion_tamano; ?>" readonly>
								  <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                              </div>
                          </div>
                        </div>
						...
						<div class="form-group">
                            <label class="col-sm-222 control-label"><i class="fa fa-hashtag" aria-hidden="true"></i> Número de Lote</label>
                             <div class="col-sm-110">
                              <div class='input-group'>
                                <input type="text" class="form-control" name="no_lote" placeholder="Por ejemplo: 287456" value="<?php echo $no_lote; ?>" readonly>
                                <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                              </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-222 control-label"><i class="fa fa-calendar-times-o" aria-hidden="true"></i> Fecha de Expiración</label>
                             <div class="col-sm-110">
                              <div class='input-group'>
                                <input type="text" class="form-control" name="fecha_exp" value="<?php echo $exp_fecha; ?>" readonly>
                                <span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
                              </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          <div class="col-sm-offset-2 col-sm-10 text-center"><br>
                              <button type="submit" name="eliminar_particula" class="btn btn-danger">Eliminar</button>
                          </div>
                        </div>
                    <br>
            </form>
