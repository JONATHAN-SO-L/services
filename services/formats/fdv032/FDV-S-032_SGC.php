...
if ($_SESSION['nombre'] != '' && $_SESSION['tipo'] == 'devecchi' || $_SESSION['tipo'] == 'admin') {
    ...
    // Buscar el nombre del formato y su revisión
    ...
    **********************************/
    ...
    $filename = $dir.'FDV-S-032_SGC.png';
    $size = 5;
    $level = 'S';
    $framesize = 1;
    $contenido = 'https://veco.lat/services/formats/qr_codes/certificate_info.php?';
    ...
    ******************************/
    ...
    $pdf->SetXY(43,220);
    $pdf->SetFont("Arial","b",10);
    $pdf->Cell(15,5,utf8_decode('ELABORADO POR:'),0,0,'C');
    $pdf->SetFont("Arial","",10);
    $pdf->Line(23,236,80,236);
    $pdf->SetXY(44,237);
    ...
    $pdf->Cell(3,3,'',1,1,'C');
    $pdf->SetXY(135,248);
    $pdf->Cell(5,5,utf8_decode('Jefatura de Servicios'),0,0,'C');
