    ...
    function redirect_failed($id_documento) {
        echo '
            <div class="container" style="margin-left: 40%">
                ...
                <br>
                <a href="../../certifies/fdv/032/mod/mod_instruments.php?'.$id_documento.'" class="btn btn-sm btn-danger" style="margin-left: 15%">Regresar</a>
            </div>';
    }
    ...
    if (isset($_POST['guardar_cambios_instrumentos'])) {
        ...
        $save_instruments = $con->prepare("UPDATE $certified
                                                    SET dmm_activo = ?, dmm_modelo = ?, dmm_numero_serie = ?, dmm_numero_control = ?, dmm_fecha_calibracion = ?, dmm_proxima_calibracion = ?,
                                                        ...
                                                        modifica_data = ?, fecha_hora_modificacion = ?, fecha_documento = ?
                                            WHERE id_documento = ?");
        ...
        $val_save_instruments = $save_instruments->execute([$dmm_activo, $dmm_modelo, $dmm_no_serie, $dmm_control_no, $dmm_fecha_cal, $dmm_prox_cal,
                                                            ...
                                                            $balometro_activo, $balometro_modelo, $balometro_no_serie, $balometro_control_no, $balometro_fecha_cal, $balometro_prox_cal, $tecnico_mod, $fecha_hora_carga, $fecha_documento, $id_documento]);
